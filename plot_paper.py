#==============================================================#
#							                                   #
#		     plot magnetized disk for submitted paper          #
#==============================================================#    
...
def plot(\
    ...
    plot_each(sig,dotm,wt,tem,bt,taueff,yax=yax,clr=clr)
    #----------------------------------------------------------------# 
    if (sig.shape[0] != 0):
    ...
    #
    #print(sig.shape,"sad")
    #plot_each(sig,dotm,wt,tem,bt,taueff,ax,yax=yax,clr=clr)
    ##-----------------------------------------------------------------#
...
def plot_each(sig, dotm, wt, tem, bt, taueff, yax=0, clr="k"):
    
    ax[0,0].plot(sig,dotm,color=clr)
    ax[0,1].plot(sig,tem,color=clr)
    ax[1,0].plot(sig,bt,color=clr)
    ax[1,1].plot(sig,taueff,color=clr)
